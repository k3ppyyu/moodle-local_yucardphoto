...
export const init = (config) => {
    ...
    const perSelect = document.getElementById('ycp-perpage');
    const submitBtn = form.querySelector('button[type="submit"]');

    // ── Hide the explicit submit button — dropdowns and keyup handle submission ──
    if (submitBtn) {
    ...
    // ── Per-page dropdown: submit immediately on change ───────────────────
    if (perSelect) {
        perSelect.addEventListener('change', () => form.submit());
    }
